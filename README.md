...
both installable via e.g pip install. To run the code, one will also need to download SD1 Sample metadata from the Supplementary Data 1 excel file of the paper (https://doi.org/10.1038/s41467-025-66070-7) , and the GSP_Sample_Sheet.xlsx available in this repository under metagenomics/.
